/*
   This implementation of the Postman collection parser depends only on the visual analysis
   of sample Postman collections v2.1. It does not depend on any Postman library type
   definitions. Several ESLint exclusions are required as a result.
 */
